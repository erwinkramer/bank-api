...
- [OWASP API Security Top 10 - v2023](https://owasp.org/API-Security/editions/2023/en/0x11-t10/), validated via Spectral ruleset

- [OpenAPI Specification v3.0.1](https://spec.openapis.org/oas/v3.0.1.html), validated via Spectral ruleset
